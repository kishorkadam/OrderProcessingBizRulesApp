# OrderProcessingBizRulesApp
 Business Rules Engine for order processing of large organization
...
• If the payment is for a physical product or a book, generate a commission payment to the agent. 
  ...
  Designed a new system which can handle these rules and yet open to extension to new rules
